...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-white-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="https://res.cloudinary.com/dr7xwcpo7/image/upload/v1769682604/favicon_2_xsbp88.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">العضيبي</span>
    </a>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
               ...
               <li class="nav-item">
                ...
                <li class="nav-item">
                <a href="{{ route('admin.ratings2.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>التقييمات</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    {{-- <strong>Copyright &copy; 2026 <a >AdminLTE.</a>.</strong> All rights reserved. --}}
  </footer>
</div>
<!-- ./wrapper -->
